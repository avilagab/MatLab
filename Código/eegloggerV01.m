...
if plot_popup
    figure;    
    salida = output_matrix(1:end_time,4)-4064;
    plot([0:1/sampFreq:(end_time-1)/sampFreq],salida)
    disp(end_time)
    hold on
    xlabel('time (s)')
    title('Datos EEG - AF3')
