...
if plot_popup
    figure;    
    plot([0:1/sampFreq:(end_time-1)/sampFreq],output_matrix(1:end_time,1))
    hold on
    xlabel('time (s)')
    title('Datos Reloj - 0 COUNTER')
   
    figure;    
    plot([0:1/sampFreq:(end_time-1)/sampFreq],output_matrix(1:end_time,2))
    hold on
    xlabel('time (s)')
    title('Datos Reloj - 1 INTERPOLATED')
    
    figure;    
    plot([0:1/sampFreq:(end_time-1)/sampFreq],output_matrix(1:end_time,3))
    hold on
    xlabel('time (s)')
    title('Datos Reloj - 2 RAW CQ')
    
    figure;    
    plot([0:1/sampFreq:(end_time-1)/sampFreq],output_matrix(1:end_time,4))
    hold on
    xlabel('time (s)')
    title('Datos EEG - 3 AF3')
    
    figure;    
    plot([0:1/sampFreq:(end_time-1)/sampFreq],output_matrix(1:end_time,5))
    hold on
    xlabel('time (s)')
    title('Datos EEG - 4 F7')
    
    figure;    
    plot([0:1/sampFreq:(end_time-1)/sampFreq],output_matrix(1:end_time,6))
    hold on
    xlabel('time (s)')
    title('Datos EEG - 5 F3')
    
    figure;    
    plot([0:1/sampFreq:(end_time-1)/sampFreq],output_matrix(1:end_time,7))
    hold on
    xlabel('time (s)')
    title('Datos EEG - 6 FC5')
    
    figure;    
    plot([0:1/sampFreq:(end_time-1)/sampFreq],output_matrix(1:end_time,8))
    hold on
    xlabel('time (s)')
    title('Datos EEG - 7 T7')
    
    figure;    
    plot([0:1/sampFreq:(end_time-1)/sampFreq],output_matrix(1:end_time,9))
    hold on
    xlabel('time (s)')
    title('Datos EEG - 8 P7')
    
    figure;    
    plot([0:1/sampFreq:(end_time-1)/sampFreq],output_matrix(1:end_time,10))
    hold on
    xlabel('time (s)')
    title('Datos EEG - 9 O1')
    
    figure;    
    plot([0:1/sampFreq:(end_time-1)/sampFreq],output_matrix(1:end_time,11))
    hold on
    xlabel('time (s)')
    title('Datos EEG - 10 O2')
    
    figure;    
    plot([0:1/sampFreq:(end_time-1)/sampFreq],output_matrix(1:end_time,12))
    hold on
    xlabel('time (s)')
    title('Datos EEG - 11 P8')
    
    figure;    
    plot([0:1/sampFreq:(end_time-1)/sampFreq],output_matrix(1:end_time,13))
    hold on
    xlabel('time (s)')
    title('Datos EEG - 12 T8')
    
    figure;    
    plot([0:1/sampFreq:(end_time-1)/sampFreq],output_matrix(1:end_time,14))
    hold on
    xlabel('time (s)')
    title('Datos EEG - 13 FC6')
    
    figure;    
    plot([0:1/sampFreq:(end_time-1)/sampFreq],output_matrix(1:end_time,15))
    hold on
    xlabel('time (s)')
    title('Datos EEG - 14 F4')
    
    figure;    
    plot([0:1/sampFreq:(end_time-1)/sampFreq],output_matrix(1:end_time,16))
    hold on
    xlabel('time (s)')
    title('Datos EEG - 15 F8')
    
    figure;    
    plot([0:1/sampFreq:(end_time-1)/sampFreq],output_matrix(1:end_time,17))
    hold on
    xlabel('time (s)')
    title('Datos EEG - 16 AF4')
    
    figure;    
    plot([0:1/sampFreq:(end_time-1)/sampFreq],output_matrix(1:end_time,18))
    hold on
    xlabel('time (s)')
    title('Datos Giróscopo - 17 GYROX')
    
    figure;    
    plot([0:1/sampFreq:(end_time-1)/sampFreq],output_matrix(1:end_time,19))
    hold on
    xlabel('time (s)')
    title('Datos Giróscopo - 18 GYROY')
    
    figure;    
    plot([0:1/sampFreq:(end_time-1)/sampFreq],output_matrix(1:end_time,20))
    hold on
    xlabel('time (s)')
    title('Datos - 19 TIMESTAMP')
    
    figure;    
    plot([0:1/sampFreq:(end_time-1)/sampFreq],output_matrix(1:end_time,21))
    hold on
    xlabel('time (s)')
    title('Datos - 20 ES TIMESTAMP')
    
    figure;    
    plot([0:1/sampFreq:(end_time-1)/sampFreq],output_matrix(1:end_time,22))
    hold on
    xlabel('time (s)')
    title('Datos - 21 FUNC ID')
    
    figure;    
    plot([0:1/sampFreq:(end_time-1)/sampFreq],output_matrix(1:end_time,23))
    hold on
    xlabel('time (s)')
    title('Datos - 22 FUNC VALUE')
    
    figure;    
    plot([0:1/sampFreq:(end_time-1)/sampFreq],output_matrix(1:end_time,24))
    hold on
    xlabel('time (s)')
    title('Datos - 23 MARKER')
    
    figure;    
    plot([0:1/sampFreq:(end_time-1)/sampFreq],output_matrix(1:end_time,25))
    hold on
    xlabel('time (s)')
    title('Datos - 24 SYNC SIGNAL')
end
